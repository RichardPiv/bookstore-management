...
import { CreateAlertTypeInput, UpdateAlertTypeInput } from "./types";
...
/** Validate the body of a POST /api/alert-types. */
export function validateCreateAlertTypeInput(
  body: unknown,
...
/** Validate the body of a PATCH /api/alert-types/:id. */
export function validateUpdateAlertTypeInput(
  body: unknown,
  ...
  const { name } = body as Record<string, unknown>;
  const update: UpdateAlertTypeInput = {};
