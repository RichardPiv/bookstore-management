...
import { CreateDeliveryStatusInput, UpdateDeliveryStatusInput } from "./types";
...
/** Validate the body of a POST /api/delivery-statuses. */
export function validateCreateDeliveryStatusInput(
  body: unknown,
): CreateDeliveryStatusInput {
...
/** Validate the body of a PATCH /api/delivery-statuses/:id. */
export function validateUpdateDeliveryStatusInput(
  body: unknown,
  ...
  const { name } = body as Record<string, unknown>;
  const update: UpdateDeliveryStatusInput = {};
